...
public partial class ReaderT<R,M>;


partial class ReaderT<R, M> : IFunctor<ReaderT<R, M>> {
...
partial class ReaderT<R, M> : IApplicative<ReaderT<R, M>> {
...
partial class ReaderT<R, M> : IMonad<ReaderT<R, M>> {
